  ...
  server: {
    handlers: {
      GET: async ({ request }) => {
        ...
        const paths = ["Documentation", "What is Namera?"];
          ...
          <div tw="bg-[#0B0C14] h-full w-full flex items-center">
            ...
            <div tw="w-[90dvw] flex flex-col gap-8 h-[60dvh] mx-auto">
              ...
              <div tw="flex flex-row gap-2 text-[#C9D3EE] text-xl items-center">
                ...
                <div>Updated 8 days ago</div>
              </div>
              <div tw="text-xl text-[#9D9FAF] max-w-[80dvw] text-wrap">
                Namera is a programmable session key for smart contracts
                accounts. It allows you to create a session key that can be used
                to sign messages, verify signatures, and more. This is useful
