  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, rgba(214,254,81,0.5), transparent)",
        }}
      />
      {/* Glow */}
      <div
      ...
      <div className="relative flex flex-col gap-3 px-5 py-6 font-mono text-sm">
        ...
        {policyRows.map((row) => (
          ...
          >
            ...
            {row.enforced ? (
              <span className="inline-flex items-center gap-1.5 text-[#d6fe51]">
                {row.value}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 30% 50%, rgba(214,254,81,0.08), transparent 70%), radial-gradient(ellipse 40% 50% at 80% 50%, rgba(182,214,255,0.06), transparent 70%)",
        }}
      />
      ...
      <div className="relative flex flex-col gap-4">
        ...
        <h2 className="heading-gradient mx-auto max-w-3xl pb-2 text-center text-3xl tracking-tight sm:text-4xl md:text-5xl">
          Fine-grained control. Onchain enforcement.
        </h2>
      </div>
