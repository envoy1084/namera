...
export const Products = () => {
  return (
    <section className="px-4 max-w-7xl mx-auto py-[5dvh]" id="products">
      <h2 className="text-5xl max-w-xl mx-auto text-center heading-gradient pb-2">
        Everything you need to build agent wallets
      </h2>
      <div className="grid grid-cols-3 gap-8 py-24 max-w-5xl mx-auto">
